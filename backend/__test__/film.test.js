...
it(`Test /getAll/nowShowing route`, (done) => {
...
it(`Test /getAll/upcoming route`, (done) => {
...
it(`Test /delete/:id route`, (done) => {
    ...
    .end((err,res) => {
        ...
        expect(res).to.have.property('text', 'succesfully deleted');
        done();
    });
});
